...
ActiveRecord::Schema.define(version: 20160722192317) do
  ...
  add_index "taggings", ["reflection_id"], name: "index_taggings_on_reflection_id", using: :btree
  ...
  add_foreign_key "taggings", "reflections"
